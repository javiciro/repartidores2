...
|--------------------------------------------------------------------------
|
| Set up an alternative logo for login and register screens.
| When disabled, the admin panel logo will be used instead.
| For detailed instructions, check the auth logo section:
| https://github.com/jeroennoten/Laravel-AdminLTE/wiki/Basic-Configuration
|
*/
'auth_logo' => [
...
|--------------------------------------------------------------------------
|
| Customize the preloader animation configuration.
| For detailed instructions, check the preloader section:
| https://github.com/jeroennoten/Laravel-AdminLTE/wiki/Basic-Configuration
|
*/
'preloader' => [
